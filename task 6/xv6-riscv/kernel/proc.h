...
struct proc {
  ...
  //Task 5 fields
  long long accumulator;       // Accumulator for task 5
  int ps_priority;             // Process priority for task 5
  //Task 6 fields
  ...
  long long last_executed;      // When was the process last executed - for caclutaling retime
